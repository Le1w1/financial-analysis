...
Los inversores necesitan comparar el rendimiento, riesgo y tendencia de múltiples acciones en un solo lugar. 

Este proyecto automatiza ese proceso: desde la extracción de datos crudos hasta la visualización de métricas financieras clave, sin intervención manual.
